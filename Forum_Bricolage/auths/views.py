...
def login(request):
    ...
    if request.method == "POST":
        ...
        return render(request, 'auths/connexion.html', {'error_fields': error_fields})
    return render(request,'auths/connexion.html')
...
def signup(request):
    if request.method == "POST":
        ...
        if error_fields:
            return render(request, 'auths/inscription.html', {'error_fields': error_fields})
    ...
    return render(request, 'auths/inscription.html')
